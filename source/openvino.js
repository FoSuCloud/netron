...
openvino.Graph = class {
    ...
    constructor(metadata, net, bin) {
        ...
        // Validation
        // all render elements are split between inputs and nodes
        // by definition IR is a render can have inputs of two types: "Input" and "Const"
        // "Input" layers are already moved to inputs when we parse a render
        // if there are any layers that do not have input value and they are no Const ones
        // this means that this render was not properly processed by the render building logic
